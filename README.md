...
The objective of this analysis is to understand the sales, profitability, order volume, product performance, store performance, customer behaviour, and sales-channel trends of the retail business by analyzing its sales and order data.
The analysis combines information from the Products, Stores, Orders, Order Items, Customers, and Employees tables to provide a comprehensive view of business performance.

The analysis seeks to answer the following key business questions:

**1.	Which Product Categories Drive the Biggest Profits, Quantity and Revenue? 
Is this the same across different store types?**

This question seeks to identify which product categories contribute the most to revenue, quantity sold, and profit, and whether the performance of these categories remains consistent across different store types.
